...
public String toString() {
	return "courseBean [courseID=" + courseID + ", courseTitle=" + courseTitle + ", retakeDuration=" + retakeDuration
			+ ", startSkip=" + startSkip + ", endSkip=" + endSkip + ", dataLocation=" + dataLocation + "]";
}
